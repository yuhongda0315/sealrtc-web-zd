(function (dependencies) {
  ...
  function getSelfMediaStream(n) {
    var StreamType = rongRTC.StreamType;
    return new Promise(function (resolve, reject) {
      navigator.getUserMedia({ video: false, audio:true }, function (ms) {
        var user = {
          id: loginUserId,
          stream: {
            mediaStream: ms,
  ...
  function addUserStream(user) {
    ...
    if (isSelf) {
      ...
      user.stream.size = rongRTC.StreamSize.MAX;
  ...
  function publishSelfMediaStream(videoEnable, audioEnable, resolution, frameRate, audioOnly) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      getSelfMediaStream().then(function (user) {
        console.timeEnd('get ')
