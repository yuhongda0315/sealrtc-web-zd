/**
 * RongRTC.js v3.2.5
 * CodeVersion: f19086f063d5bfb928557ab0480acfedfc787a96
 * Release Date: Wed Aug 19 2020 16:33:47 GMT+0800 (GMT+08:00)
            ...
            now.forEach(function (item) {
              ...
              for (var i = before.length - 1; i >= 0; i -= 1) {
                var _before$i = before[i],
                    bmediaType = _before$i.mediaType,
                    bmsid = _before$i.msid,
                    bstate = _before$i.state;

                if (mediaType === bmediaType && msid === bmsid) {
                  if (state !== bstate) {
                    // 状态变更的资源
                    modified.push(item);
                  }
